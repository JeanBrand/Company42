...
var navbar = (function(id)
{
    ...
    function initControls(id)
    {
        ...
        divContactUs.style.cssText = "border: 1px solid #8BC34A;border-radius: 7px;color: #8BC34A;cursor: pointer;right: 60px;height: 40px;width: 180px;text-align: center;line-height: 39px;position: absolute;z-index: 4;";
        ...
        divLogo.style.cssText = "color: #FFF;cursor: pointer;font-size: 30px;position: absolute;z-index: 4;top: -24px;left: 60px;";
