...
var advert = (function()
{
    ...
    function initControls()
    {
        ...
        adHolder.style.backgroundImage = "url('images/bg3.jpg')";

        divHeaderTitle.style.cssText = "color: #FFF;width: 1000px;position: absolute;z-index: 9;top: 303px;left: 24%;font-size: 44px;padding: 15px;";
        divHeaderTitle.innerHTML = "TAKING YOUR BUSINESS TO NEW HORIZONS";
        wrapper.appendChild(divHeaderTitle);

        divCompanyTitle.style.cssText = "color: #FFF;height: 200px; width: 640px;position: absolute;z-index: 9;top: 235px;left: 44%;font-size: 26px; font-weight: 100;";
        divCompanyTitle.innerHTML = "COMPANY 42";
        wrapper.appendChild(divCompanyTitle);

        divFooterTitle.style.cssText = "color: #FFF; width: 640px;position: absolute;z-index: 9;top: 416px;left: 37%;font-size: 26px; font-weight: 100;";
        divFooterTitle.innerHTML = "PRECISE.EFFICIENT.INTELLIGENT";
        wrapper.appendChild(divFooterTitle);


        picture1.style.cssText = "height: 633px;width: 710px;position: absolute;top: 175px;right: -215px;";
        picture1.src = "images/move_3_bg.png";
        adHolder.appendChild(picture1);

        picture2.style.cssText = "height: 390px;width: 790px;position: absolute;top: 530px;left: -130px;-webkit-transform: rotate(190deg);";
        picture2.src = "images/pic3_1.png";
        ...
        imgHTML5.src = "images/html5_2.png";
        ...
        imgJavascript.src = "images/javascript_2.png";
        ...
        imgJQuery.src = "images/jquery_6.png";
